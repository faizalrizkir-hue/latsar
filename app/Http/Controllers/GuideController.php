...
class GuideController extends Controller
{
    ...
    private const GUIDES = [
        [
            ...
            'description' => 'Panduan pengelolaan akun, preferensi element, informasi umum, DMS, dan monitoring progres penilaian.',
            'preferred_file' => 'administrator.pdf',
            'keywords' => ['administrator', 'admin', 'pengelola'],
            'accent' => 'blue',
            'embed' => [
                'url' => 'https://online.fliphtml5.com/bpnya/skeq/',
        ...
        [
            ...
            'accent' => 'teal',
            'embed' => [
                'url' => 'https://online.fliphtml5.com/bpnya/wrvz/',
