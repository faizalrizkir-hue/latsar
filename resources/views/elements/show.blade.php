...
@section('content')
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <p class="text-muted mb-3">Konten detail topik ini belum dipindahkan. Anda bisa gunakan tombol di bawah untuk membuka dokumen referensi atau lakukan input/penilaian langsung (TODO).</p>
