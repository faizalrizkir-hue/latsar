...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('element1_jasa_konsultansi')) {
            return;
        }

        Schema::create('element1_jasa_konsultansi', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('element1_jasa_konsultansi');
    }
};
