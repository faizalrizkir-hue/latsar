...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('element3_pelaporan_manajemen_kld')) {
            return;
        }

        Schema::create('element3_pelaporan_manajemen_kld', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('element3_pelaporan_manajemen_kld');
    }
};
