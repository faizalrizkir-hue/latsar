...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('element2_pelaksanaan_penugasan')) {
            return;
        }

        Schema::create('element2_pelaksanaan_penugasan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('element2_pelaksanaan_penugasan');
    }
};
