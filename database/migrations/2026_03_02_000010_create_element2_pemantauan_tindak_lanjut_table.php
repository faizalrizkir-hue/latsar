...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('element2_pemantauan_tindak_lanjut')) {
            return;
        }

        Schema::create('element2_pemantauan_tindak_lanjut', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('element2_pemantauan_tindak_lanjut');
    }
};
