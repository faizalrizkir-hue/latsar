...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('element4_manajemen_kinerja')) {
            return;
        }

        Schema::create('element4_manajemen_kinerja', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('element4_manajemen_kinerja');
    }
};
