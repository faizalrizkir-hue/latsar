...
return new class extends Migration
{
    public function up(): void
    {
        foreach ($this->moduleTables() as $table) {
            if (!Schema::hasTable($table) || Schema::hasColumn($table, 'qa_follow_up_recommendation')) {
                continue;
            }

            Schema::table($table, function (Blueprint $blueprint) {
                $blueprint->text('qa_follow_up_recommendation')->nullable()->after('qa_verify_note');
            });
        }
    }
    ...
    public function down(): void
    {
        foreach ($this->moduleTables() as $table) {
            ...
            Schema::table($table, function (Blueprint $blueprint) {
                $blueprint->dropColumn('qa_follow_up_recommendation');
            });
        }
    }
