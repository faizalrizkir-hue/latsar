...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('element2_pengendalian_kualitas')) {
            return;
        }

        Schema::create('element2_pengendalian_kualitas', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('element2_pengendalian_kualitas');
    }
};
