...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('element2_pengembangan_informasi')) {
            return;
        }

        Schema::create('element2_pengembangan_informasi', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('element2_pengembangan_informasi');
    }
};
