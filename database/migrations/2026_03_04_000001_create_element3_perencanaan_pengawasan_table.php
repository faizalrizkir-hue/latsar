...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('element3_perencanaan_pengawasan')) {
            return;
        }

        Schema::create('element3_perencanaan_pengawasan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('element3_perencanaan_pengawasan');
    }
};
