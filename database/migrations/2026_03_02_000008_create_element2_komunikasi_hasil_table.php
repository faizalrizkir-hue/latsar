...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('element2_komunikasi_hasil')) {
            return;
        }

        Schema::create('element2_komunikasi_hasil', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('element2_komunikasi_hasil');
    }
};
