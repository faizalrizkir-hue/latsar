...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('element5_hubungan_apip_manajemen')) {
            return;
        }

        Schema::create('element5_hubungan_apip_manajemen', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('element5_hubungan_apip_manajemen');
    }
};
