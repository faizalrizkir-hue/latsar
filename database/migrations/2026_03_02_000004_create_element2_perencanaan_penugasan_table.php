...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('element2_perencanaan_penugasan')) {
            return;
        }

        Schema::create('element2_perencanaan_penugasan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('element2_perencanaan_penugasan');
    }
};
