...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('element4_mekanisme_pendanaan')) {
            return;
        }

        Schema::create('element4_mekanisme_pendanaan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('element4_mekanisme_pendanaan');
    }
};
