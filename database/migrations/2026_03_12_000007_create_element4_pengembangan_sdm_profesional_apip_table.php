...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('element4_pengembangan_sdm_profesional_apip')) {
            return;
        }

        Schema::create('element4_pengembangan_sdm_profesional_apip', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('element4_pengembangan_sdm_profesional_apip');
    }
};
