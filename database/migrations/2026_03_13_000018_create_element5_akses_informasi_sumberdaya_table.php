...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('element5_akses_informasi_sumberdaya')) {
            return;
        }

        Schema::create('element5_akses_informasi_sumberdaya', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('element5_akses_informasi_sumberdaya');
    }
};
