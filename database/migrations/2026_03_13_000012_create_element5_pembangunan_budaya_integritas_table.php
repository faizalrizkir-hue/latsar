...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('element5_pembangunan_budaya_integritas')) {
            return;
        }

        Schema::create('element5_pembangunan_budaya_integritas', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('element5_pembangunan_budaya_integritas');
    }
};
