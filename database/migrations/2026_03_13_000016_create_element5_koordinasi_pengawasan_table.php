...
return new class extends Migration
{
    ...
    {
        if (Schema::hasTable('element5_koordinasi_pengawasan')) {
            return;
        }

        Schema::create('element5_koordinasi_pengawasan', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('element5_koordinasi_pengawasan');
    }
};
